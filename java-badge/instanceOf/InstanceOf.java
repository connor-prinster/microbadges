...
public class InstanceOf {
    ...
    private void testInstanceOfPracticeClass1() {
        PracticeClass1 pc1 = new PracticeClass1();
        System.out.println("The instanceOf operator comparing 'pc1 to pc1' returns: " + (pc1 instanceof PracticeClass1));
    }

    private void testInstanceOfPracticeClass2() {
        PracticeClass2 pc2 = new PracticeClass2();
        System.out.println(
                "The instanceOf operator comparing 'pc2 to pc1'"
